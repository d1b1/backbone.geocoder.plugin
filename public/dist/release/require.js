...
this['JST']['public/app/templates/editform.html'] = function(data) { return function (obj,_) {
var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<form>\n\n<div class="map_canvas_list">\n\n</div>\n\n</form>');}return __p.join('');
}(data, _)};

this['JST']['public/app/templates/example.html'] = function(data) { return function (obj,_) {
...
this['JST']['public/app/templates/location/item.html'] = function(data) { return function (obj,_) {
var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<input type="text" size="50" placeholder="Type in an address" class="location" value="', location ,'">\n<br><br>\n\n<div style="width: 300px; height: 200px; background-color: #EFEFEF" class="map_canvas"></div>\n<br>\n<div class=\'remove\'>[remove]</div>');}return __p.join('');
}(data, _)};

this['JST']['public/app/templates/location/list.html'] = function(data) { return function (obj,_) {
var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('List of all the locations\n\n<div class="location_areas"></div>\n<div class=\'add\'>[Add New]</div>\n\n<div class="location_areas2"></div>');}return __p.join('');
}(data, _)};

this['JST']['public/app/templates/location.html'] = function(data) { return function (obj,_) {
var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\n<input type="text" size="50" placeholder="Type in an address" class="location_',i,'" value="', location ,'">\n<br><br>\n\n<div style="width: 300px; height: 200px; background-color: #EFEFEF" class="map_canvas_',i,'">\nThis is the map location 1.\n</div>\n<br>');}return __p.join('');
}(data, _)};
...
define("plugins/jquery.geocomplete", function(){});
