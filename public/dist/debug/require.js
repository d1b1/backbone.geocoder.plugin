...
this['JST']['app/templates/editform.html'] = function(data) { return function (obj,_) {
...
this['JST']['app/templates/location/item.html'] = function(data) { return function (obj,_) {
...
this['JST']['app/templates/location/list.html'] = function(data) { return function (obj,_) {
var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('List of all the locations\n\n<div class="location_areas"></div>\n<div class=\'add\'>[Add New]</div>');}return __p.join('');
}(data, _)};

this['JST']['app/templates/location.html'] = function(data) { return function (obj,_) {
